...
const ORDER_WAITING_ZALOPAY_DEADLINE= Number(process.env.ORDER_WAITING_ZALOPAY_DEADLINE)
const ORDER_PENDING_STATUS_DEADLINE= Number(process.env.ORDER_PENDING_STATUS_DEADLINE)
const ORDER_PROCESSING_STATUS_DEADLINE= Number(process.env.ORDER_PROCESSING_STATUS_DEADLINE)
const ORDER_COMPLETED_STATUS_DEADLINE= Number(process.env.ORDER_COMPLETED_STATUS_DEADLINE)
